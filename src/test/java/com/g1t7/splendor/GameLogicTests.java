...
class GameLogicTests {
    ...
    void take4CoinsRejected() {
        boolean ok = p1.exchangeCoin(List.of("WHITE", "BLUE", "GREEN", "RED"));
    ...
    void gameOverAfterFullRound() {
        ...
        // P2 takes their turn
        game.changeTurns(); // back to P1 (starting player), game should end
